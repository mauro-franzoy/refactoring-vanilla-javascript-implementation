...
> [!NOTE]
> **Disclaimer:** This is only for portfolio showcasing. The goal is to try refactoring this code to make it clean and neat according to best practices, and to add new features without downtime.
